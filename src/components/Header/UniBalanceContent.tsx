                ...
                <RowBetween>
                  ...
                  <TYPE.white color="white">
                    ...
                    {uniToClaim && uniToClaim.greaterThan('0') && (
                      <StyledInternalLink onClick={() => setShowUniBalanceModal(false)} to="/farm">
                        ({t('claim')})
                      </StyledInternalLink>
                    )}
                  </TYPE.white>
        ...
        <CardSection gap="sm">
          <AutoColumn gap="md">
            ...
            {uni && uni.chainId === ChainId.MAINNET ? (
              <ExternalLink href={`https://www.wanscan.org/token/${uni.address}`}>View BGSP Token Information</ExternalLink>
            ) : null}
          </AutoColumn>
        </CardSection>
      </ModalUpper>
